...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'http://localhost:3000/', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/infinum', // Project path relative to project root.
		},
	};
